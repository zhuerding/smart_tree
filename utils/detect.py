...
CLASSES = ['CJ', 'CT', 'Zb', 'C0', 'ZW', 'Z5', 'ZT', 'ZJ', 'CQ', 'CH', 'ZH', 'Z4', 'CG', 'CU', 'ZL', 'Cg', 'CL', 'CP',
           'C1', 'Z1', 'Ck', 'Zt', 'ZP', 'ZZ', 'CZ', 'C6', 'CA', 'ZG', 'CLFT', 'CI', 'ZN', 'Z3', 'Ci', 'Zn', 'Cn', 'ZI',
           'CX', 'ZS', 'CO', 'ZD', 'ZA', 'Zk', 'ZV', 'CY', 'QX', 'Cp', 'C8', 'Z8', 'C7', 'Cr', 'Cy', 'ZR', 'CM', 'ZF',
           'CB', 'CV', 'C5', 'CW', 'CD', 'Zi', 'Zm', 'ZE', 'Cu', 'Ca', 'Cb', 'CS', 'CE', 'Cj', 'Z0', 'Z7', 'C4', 'ZB',
           'Cf', 'Zf', 'ZM', 'ZQ', 'ZK', 'Cq', 'Z6', 'CN', 'CC', 'ZX', 'ZO', 'Zj', 'Zp', 'C9', 'Zh', 'cg', 'CF', 'Ct',
           'C', 'ZC', 'zP', 'C3', 'C2', 'Zg', 'ZY', 'cN', 'Zq', 'Za', 'YZ', 'YZT', 'Zu', 'Zr', 'Zmw', 'ch', 'Zy', "YZ'",
           'Cd', 'CK', 'cp', 'c5', 'Ce', 'Ze', 'ZU', 'za', 'Cm', 'Z9', 'Z2', 'ZW4', 'CR', 'Zw', 'Zd', 'LFT', 'Z', 'cK',
           'ZLFT', 'yz', 'zw', 'zx', 'zR', 'Zc', 'Ch', 'Zl']  # 识别标签
...
def detect(img_path):
    ...
    model = Yolov5ONNX('./Reqfile/best_simple.onnx')
